// Restart item script for Thunderbird 68+ by Aris
//
...
var RestartMenuFileAppItems = {
  init: function() {
	...
	try {
	  ...
	  if(document.getElementById("appmenu-quit").previousSibling.id != "appMenu-restart-button" )
		document.getElementById("appmenu-quit").parentNode.insertBefore(restartitem_appmenu,document.getElementById("appmenu-quit"));
	} catch(e) {}
	...
	var uri = Services.io.newURI("data:text/css;charset=utf-8," + encodeURIComponent('\
	  ...
	  #appMenu-restart-button {\
		list-style-image: url("chrome://messenger/skin/icons/reply.svg"); /* icon / path to icon */ \
	  }\
